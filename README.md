...
> :bulb: *Generally, it may take a little while before sensors register any activity/change and therefore will have the status "Unavailable" or "Unknown" initially - don't panic, be patient for the values to show. You can force your battery to charge and discharge to grid just for a moment for all the values to start to generate.*
