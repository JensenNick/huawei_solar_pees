...
> :bulb: In the [Wiki Pages](https://github.com/JensenNick/huawei_solar_pees/wiki) you will find an overview and more detailed description of all sensors included in the *"Huawei Solar PEES package"*.   
