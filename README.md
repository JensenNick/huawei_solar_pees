...
> :bulb: The [Wiki Pages](https://github.com/JensenNick/huawei_solar_pees/wiki) includes an overview and more detailed description of all sensors included in the *"Huawei Solar PEES package"*.   
